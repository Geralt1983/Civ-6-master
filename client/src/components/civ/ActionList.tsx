        ...
        {recommendations.map((rec) => (
          ...
          >
            ...
            <div className="flex justify-between items-start mb-2">
              ...
              {rec.priority === 'high' && <AlertTriangle className="w-4 h-4 text-destructive animate-pulse" />}
            </div>
            
            <h4 className="font-serif text-lg text-foreground mb-1 group-hover:text-accent transition-colors">{rec.title}</h4>
