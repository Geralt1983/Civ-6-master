-- DataExporter.lua - Civ6 Companion Data Exporter
print("Civ6Companion: Loading DataExporter...")
...
if Events and Events.TurnBegin then
    ...
    print("Civ6Companion: TurnBegin event registered!")
else
    print("Civ6Companion: ERROR - Events.TurnBegin not available")
end

print("Civ6Companion: DataExporter loaded successfully!")
